...
export async function registrarUsuario({ email, password, nombre, rol }) {
  ...
  await crearDocumentoUsuario(uid, { nombre, email, rol });

  // Envía el correo de verificación — Firebase NO lo hace automáticamente.
  try {
 ...
 * pasar nombre/rol para crear su perfil en Firestore.
