...
// ── Listar empleados (tiempo real) — el Jefe solo ve + activa/desactiva ──
function cargarEmpleados() {
  ...
  onSnapshot(q, (snap) => {
    ...
    // El Jefe SOLO puede modificar el campo "activo" (lo permiten las reglas
    // de seguridad) — no puede crear, editar nombre, ni # de empleado.
    ...
    console.error('Error cargando cuadrilla:', error);
